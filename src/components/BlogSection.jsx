...
export const BlogSection = () => {
  ...
  return (
    <section id="blog-section" className="py-24 bg-[#090D16] border-t border-slate-800/80">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {BLOG_POSTS.map((post) => (
            <div 
              key={post.id}
              className="group bg-[#0F172A]/90 rounded-3xl border border-slate-800/80 hover:border-[#00B4D8]/50 hover:shadow-2xl hover:shadow-cyan-500/10 transition-all duration-300 overflow-hidden flex flex-col justify-between"
            >
              {/* Image Container */}
              ...
              <div className="p-8 space-y-4 flex-1 flex flex-col justify-between">
                <div className="space-y-3">
                  ...
                  <h3 className="text-xl font-extrabold text-white font-heading leading-snug group-hover:text-[#00B4D8] transition-colors">
                    {post.title}
                  </h3>
                ...
                <div className="pt-4 border-t border-slate-800/80">
                  <button
                    ...
                    className="text-xs font-bold text-[#00B4D8] group-hover:text-cyan-300 flex items-center gap-2 cursor-pointer transition-colors"
                  >
